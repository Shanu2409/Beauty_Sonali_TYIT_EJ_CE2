    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <c:if test="${not empty userObj}">
                ...
                <a href="/Beauty" class="btn btn-success"><i class="fas fa-user"></i> ${userObj.name}</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="/Beauty"><i class="fa-solid fa-house"></i> Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active">
        ...
        <form class="form-inline my-2 my-lg-0">
            ...
            <a href="help.jsp" class="btn btn-light my-2 my-sm-0 ml-1" type="submit"><i class="fa-solid fa-address-book"></i> Contact Us</a>
        </form>
    </div>
</nav>